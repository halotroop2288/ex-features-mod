...
public class EntityRegistry
{
	...
	public static void registerEntityRenderers()
	{
		EntityRendererRegistry.INSTANCE.register(STEVE_VILLAGER,
			(entityRenderDispatcher, context) -> new SteveVillagerRenderer(entityRenderDispatcher, new SteveVillagerModel(1, 64, 32), 1));
		EntityRendererRegistry.INSTANCE.register(PIGMAN, (entityRenderDispatcher, context) -> new PigmanRenderer(entityRenderDispatcher, new PigmanModel(1), 1));
		EntityRendererRegistry.INSTANCE.register(SEAT, (entityRenderDispatcher, context) -> new InvisibleEntityRenderer<SeatEntity>(entityRenderDispatcher));
	}
}
