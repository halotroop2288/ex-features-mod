...
public class CustomPlayerInventoryScreen extends AbstractInventoryScreen<PlayerContainer> implements RecipeBookProvider
{
	public static final Identifier BACKGROUND_TEXTURE = new Identifier("exfeatures", "textures/gui/container/inventory.png");
	private static final Identifier RECIPE_BUTTON_TEX = new Identifier("minecraft", "textures/gui/recipe_button.png");
	...
	protected void init()
	{
		...
		else
		{
			...
			this.addButton(new TexturedButtonWidget(this.x + 120, this.height / 2 - 22, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEX, (buttonWidget) ->
			{
	...
	public boolean mouseClicked(double mouseX, double mouseY, int button)
	{
		if (this.recipeBook.mouseClicked(mouseX, mouseY, button))
			return true;
		else return this.isNarrow && this.recipeBook.isOpen() ? false : super.mouseClicked(mouseX, mouseY, button);
	}
